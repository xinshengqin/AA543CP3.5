...
velocityField1 = velocityField(mesh1,IC_stepFunction,1,0.4,'periodic',0,0)#Arguments are mesh object, initial condition function ( for now, two options can
a=0.5
tfinal=3
nsteps=100
LaxWendroff(a,velocityField1,tfinal,nsteps,'./periodic_squarewave')
